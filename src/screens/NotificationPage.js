...
export default class NotificationPage extends React.Component {
    ...
    _rowRenderer(type, data) {
        ...
        switch (type) {
            ...
            case ViewTypes.FULL:
                return (
                  <View style={{flexWrap:'wrap',flexDirection:'row', margin:15, justifyContent:"center"}}>
                        <Image
                                source={require('../images/Ellipse89.png')}
                                style={{width: 40,height:40,  }}
                                /> 
                       <Text style={{flex:1,margin: 10, fontFamily:'Montserrat-SemiBold'}}>Notification item {data}</Text>
                    </View>
