                     ...
                     <View style={styles.containerGridLeft}>
                         <TouchableOpacity style={{width:'100%', height:'100%'}}>
                            <Image
                                ...
                                style={{width: 110,height:110, position:'absolute',left:10 }}
                            />
                            <Text style={{position:"absolute", left:0,bottom:-20,  fontFamily:"Roboto-Medium", fontSize: 90, textShadowColor:'#fff', textShadowRadius:10,}}>
                                {data.item.id}
                            </Text>
                         </TouchableOpacity>
